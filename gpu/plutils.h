...
void init_blocking_gpu(size_t *max_total_n, size_t *max_reads,
                       size_t *min_n, Misc misc);  // for blocking_gpu
void init_stream_gpu(size_t *max_total_n, size_t *max_reads,
                     size_t *min_n, Misc misc);  // for stream_gpu
